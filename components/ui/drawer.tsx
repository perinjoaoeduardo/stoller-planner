...
function DrawerOverlay({
  ...
  return (
    <DrawerPrimitive.Backdrop
      ...
      className={cn(
        // Só escurece: o backdrop-blur borrava a página inteira e o
        // resultado era uma mancha cinza sem forma atrás do drawer. Um
        // scrim limpo mantém o contexto legível por baixo — que é o
        // motivo de ser drawer e não página.
        "fixed inset-0 z-50 min-h-dvh bg-foreground/40 opacity-[max(var(--drawer-overlay-min-opacity,0),calc(1-var(--drawer-swipe-progress)))] transition-opacity duration-450 ease-[cubic-bezier(0.32,0.72,0,1)] select-none data-ending-style:pointer-events-none data-ending-style:opacity-0 data-ending-style:duration-[calc(var(--drawer-swipe-strength)*400ms)] data-snap-points:[--drawer-overlay-min-opacity:0.5] data-starting-style:opacity-0 data-swiping:duration-0 supports-[-webkit-touch-callout:none]:absolute",
        className
      )}
      {...props}
    />
      ...
      >
        <DrawerPrimitive.Popup
          ...
          className={cn(
            ...
            // Área segura: no celular o drawer de baixo encosta na borda
            // inferior, onde mora a barra de gestos. Sem esta reserva o
            // botão primário do rodapé fica embaixo dela — clicável só
            // por sorte. Vale para todos os drawers de uma vez.
